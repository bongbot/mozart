...
#   #----------------------------------------------------------------------------
#   def update
#     subscriber = Subscriber.find(email: @user.email)
#     puts "TTT:A: " + subscriber.inspect
#     if subscriber
#       subscriber.update_attributes(params.require(:user).permit(:password, :password_confirmation))
#       subscriber.update_attributes({pwd: params.require(:user).permit(:password)})
#     end
#
#     if true
